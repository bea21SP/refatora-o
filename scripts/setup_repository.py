...
# Aponta para o arquivo .env que está uma pasta acima (na raiz do projeto)
caminho_do_env = os.path.join(os.path.dirname(__file__), '..', '.env')
...
# Linha teste
print("O token foi encontrado?", "Sim!" if GITHUB_TOKEN else "Não...")
